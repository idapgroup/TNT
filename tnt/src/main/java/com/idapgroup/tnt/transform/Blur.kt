...
fun Bitmap.blur(
    ...
    return when {
        ...
        radius != null -> blurInner(radius, context)
        else -> this
    }
}
...
private fun Bitmap.blurInner(
    ...
    return if (context != null
        ...
        try {
            rsBlur(context, radius)
        } catch (e: RSRuntimeException) {
            stackBlur(radius, true)
        }
    } else {
        stackBlur(radius, true)
    }
...
private fun Bitmap.stackBlur(radius: Int, canReuseInBitmap: Boolean): Bitmap {
